          ...
          <div className="flex flex-col w-64">
            <div className="flex flex-col h-0 flex-1 border-r border-gray-200 bg-white">
              <div className="flex items-center h-16 flex-shrink-0 px-4 bg-primary-700">
                <h1 className="text-xl font-bold text-white">AdVantage</h1>
              </div>
                ...
                {user && (
                  <div className="flex items-center">
                    ...
                    <button
                      ...
                      className="ml-6 px-3 py-1.5 border border-gray-300 rounded-md text-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none"
                    >
                      Sign out
                    </button>
                  </div>
